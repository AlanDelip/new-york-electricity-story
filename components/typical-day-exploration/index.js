...
export default function load(data, scrollCtrl) {
	...
	createTriggerScene(scrollCtrl, "#typical-day-exploration-trigger-4",
		{
			startCB: e => {
	...
	createFixedScene(
		scrollCtrl,
		"#typical-day-temp-chart",
		"#typical-day-exploration-trigger-5",
		{duration: document.getElementById("typical-scene").offsetHeight - 400}
	);

	createTriggerScene(scrollCtrl, "#typical-day-exploration-trigger-6",
		{
			startCB: e => {
				if (e.scrollDirection === "FORWARD") {
					linePlot.removeAll();
	...
	createTriggerScene(scrollCtrl, "#typical-day-exploration-trigger-7",
		{
			startCB: e => {
				if (e.scrollDirection === "FORWARD") {
					linePlot.removeAll();
	...
	createTriggerScene(scrollCtrl, "#typical-day-exploration-trigger-8",
		{
			startCB: e => {
				if (e.scrollDirection === "FORWARD") {
					linePlot.removeAll();
	...
	createTriggerScene(scrollCtrl, "#typical-day-exploration-trigger-9",
		{
			startCB: e => {
				if (e.scrollDirection === "FORWARD") {
					linePlot.removeAll();
